...
/**
 * Created by maidinh on 19-Oct-18.
 */
...
public class TinyDB {
    ...
    public ArrayList<TreeUserDTOTemp> getListTreeTmp(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<TreeUserDTOTemp> objects = new ArrayList<TreeUserDTOTemp>();

        for (String jObjString : objStrings) {
            TreeUserDTOTemp value = (TreeUserDTOTemp) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO> getListTree(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO> objects = new ArrayList<com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO>();

        for (String jObjString : objStrings) {
            com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO value = (com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
...
//    }
    ...
    public void putListTreeUserDTO(String key, ArrayList<com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO> stringList) {
        checkForNullKey(key);
        TreeUserDTO[] myStringList = stringList.toArray(new TreeUserDTO[stringList.size()]);
        preferences.edit().putString(key, TextUtils.join("‚‗‚", myStringList)).apply();
    }

    public void putListTreeUserDTOTemp(String key, ArrayList<com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO> stringList) {
        checkForNullKey(key);
        TreeUserDTO[] myStringList = stringList.toArray(new TreeUserDTO[stringList.size()]);
        preferences.edit().putString(key, TextUtils.join("‚‗‚", myStringList)).apply();
    }
...
//    }
//
    public void putListObject(String key, ArrayList<com.dazone.crewchatoff.Tree.Dtos.TreeUserDTO> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
    ...
    public void putListObjectTmp(String key, ArrayList<TreeUserDTOTemp> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Object obj : objArray) {
