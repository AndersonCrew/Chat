...
import com.dazone.crewchatoff.adapter.AttachGalleryAdapter;
import com.dazone.crewchatoff.constant.Statics;
import com.dazone.crewchatoff.dto.AttachDtoCustomGallery;
...
public class AttachImageCustomGalleryActivity extends Activity {
	...
	private void initImageLoader() {
		try {
			String CACHE_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + Statics.TEMP_PATH_IMAGE;
